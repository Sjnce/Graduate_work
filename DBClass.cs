...
namespace Graduate_work
{
    ...
    {
        MySqlConnection conn = new MySqlConnection(@"server=147.45.239.24;port=3306;username=dvorn1234;password=oj=FtQGU~!J8n.;database=Dvorniy"); //подключение к бд
        // @"server=147.45.239.24;port=3306;username=dvorn1234;password=oj=FtQGU~!J8n.;database=Dvorniy"
        // @"server=localhost;port=3306;username=root;password=root;database=graduate_workdb"
